...
public class NewAssetArrayAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final ArrayList<String> barcodeValues;
    private final ArrayList<String> idList;


    public NewAssetArrayAdapter(Context context, ArrayList<String> barcodeList, ArrayList<String> idList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( context, AssetDetail.class );
